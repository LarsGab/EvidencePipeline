...
from EvidencePipeline.utility import file_format, run_subprocess, make_directory, file_exists_and_not_empty
        ...
        for record in SeqIO.parse(transdecoder_pep, "fasta"):
            ...
            if "type:5prime_partial" in record.description or "type:internal" in record.description:
                ...
                if m_position != -1:
                    ...
                    coords_match = re.search(r":(\d+)-(\d+)\([\+\-]\)", record.description)
